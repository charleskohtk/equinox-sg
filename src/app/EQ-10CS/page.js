...
const product = {
  ...
  description:
  'Product Code: EQ-10CS',
  highlights: [
    'Strong magnetic adsorption',
    'Semiconductor cooling',
    'Smart cooling fan',
    '15W/10W fast charging',
    'RGB lightings',
    "*Wireless fast-charging requires 25W or higher adapter",
  ],
  details: [
    'Input: DC12V/1.5-2A,9V/2-2.5A,5V/2A',
    'Output: 15W/10W/7.5W/5W',
    'Charging Type: Type C',
    'Housing material: ABS + Tempered glass',
    'Product size: 7.2*4.54*7.2cm',
    'Product net weight: 107g',
  ]
}
