...
const product = {
  name: 'Multi-Purpose Portable Vacuum Cleaner',
  price: 'S$68',
  href: '#',
  images: [
    {
  ...
  details: [
    'Input: 5V/2.4A (Max)',
    'Rated power: 120W',
    'Battery capacity: 14.8V Li-ion, 4pcs of 2000mAh (5C power battery)',
    'Filter type: Stainless steel + HEPA + sponge',
    'Working time: 18000Pa 15 mins; 8000Pa 30 mins',
    'Dustbin capacity: 150ml',
    'Max Suction (fully charged): 18000pa',
    'Housing material: Aluminium + ABS + PC',
    'Product Size: 280*55mm',
    'Product net weight: 0.75kgs (with battery)',
  ]
}
